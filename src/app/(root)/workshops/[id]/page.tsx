...
import { fetchWorkshopById } from '@/lib/actions/workshop/fetchWorkshopsActions';
import { fetchEnrollmentPages } from '@/lib/actions/enrollment/fetchEnrollmentPagesAction';
import { validateWorkshopAccess } from '@/lib/actions/workshop/validateWorkshopAccessAction';
...
const WorkshopInfoPage = async ({
  ...
  const hasAccess = await validateWorkshopAccess(id, user);
